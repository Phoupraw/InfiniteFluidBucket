...
interface MCauldronBehavior {
    ...
    private static ItemStack checkInf(ItemStack inputStack, PlayerEntity player, ItemStack outputStack, Operation<ItemStack> original) {
        return Infinities.isInfinityFluidBucket(inputStack) || Infinities.isInfinityPotion(inputStack) || Infinities.isInfinityGlassBottle(inputStack) ? inputStack : original.call(inputStack, player, outputStack);
    }
}
