...
public interface InfinityFluidStorages {
    ...
    SingleSlotStorage<FluidVariant> BUCKET_EMPTY = InfinityEmptyStorage.of(FluidVariant.blank(), FluidConstants.BUCKET);
    SingleSlotStorage<FluidVariant> BOTTLE_WATER = InfinityFullStorage.of(FluidVariant.of(Fluids.WATER), FluidConstants.BOTTLE);
    SingleSlotStorage<FluidVariant> BOTTLE_EMPTY = InfinityEmptyStorage.of(FluidVariant.blank(), FluidConstants.BOTTLE);
}
