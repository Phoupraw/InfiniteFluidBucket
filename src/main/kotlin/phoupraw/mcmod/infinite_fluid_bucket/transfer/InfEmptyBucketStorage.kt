...
class InfEmptyBucketStorage(override val capacity: Long) : SingleSlotStorage<FluidVariant>, InsertionOnlyStorage<FluidVariant> {
    ...
    override fun insert(resource: FluidVariant, maxAmount: Long, transaction: TransactionContext): Long = min(maxAmount, capacity)
